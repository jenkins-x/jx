...
func TestStepValidate(t *testing.T) {
	t.Parallel()
	AssertValidateWorks(t, &cmd.StepValidateOptions{StepOptions: cmd.StepOptions{CommonOptions: &cmd.CommonOptions{}}})
	AssertValidateWorks(t, &cmd.StepValidateOptions{StepOptions: cmd.StepOptions{CommonOptions: &cmd.CommonOptions{}}, MinimumJxVersion: "0.0.1"})

	AssertValidateFails(t, &cmd.StepValidateOptions{StepOptions: cmd.StepOptions{CommonOptions: &cmd.CommonOptions{}}, MinimumJxVersion: "100.0.1"})
	...
	AssertValidateFails(t, &cmd.StepValidateOptions{StepOptions: cmd.StepOptions{CommonOptions: &cmd.CommonOptions{}}, Dir: projectDir})
}
