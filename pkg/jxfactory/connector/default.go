...
func (c *defaultClient) Connect(connector *v1.RemoteConnector) (*rest.Config, error) {
...
func (c *defaultClient) createConfig(connector *v1.RemoteConnector, dir string) (*rest.Config, error) {
