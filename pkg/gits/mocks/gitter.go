...
func (mock *MockGitter) CreatePushURL(_param0 string) (string, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockGitter().")
	}
	params := []pegomock.Param{_param0}
...
func (mock *MockGitter) PrintCreateRepositoryGenerateAccessToken(_param0 io.Writer) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockGitter().")
	}
	params := []pegomock.Param{_param0}
...
func (verifier *VerifierMockGitter) CreatePushURL(_param0 string) *MockGitter_CreatePushURL_OngoingVerification {
	params := []pegomock.Param{_param0}
...
func (c *MockGitter_CreatePushURL_OngoingVerification) GetCapturedArguments() string {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockGitter_CreatePushURL_OngoingVerification) GetAllCapturedArguments() (_param0 []string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
		_param0 = make([]string, len(params[0]))
		for u, param := range params[0] {
...
func (verifier *VerifierMockGitter) PrintCreateRepositoryGenerateAccessToken(_param0 io.Writer) *MockGitter_PrintCreateRepositoryGenerateAccessToken_OngoingVerification {
	params := []pegomock.Param{_param0}
...
func (c *MockGitter_PrintCreateRepositoryGenerateAccessToken_OngoingVerification) GetCapturedArguments() io.Writer {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockGitter_PrintCreateRepositoryGenerateAccessToken_OngoingVerification) GetAllCapturedArguments() (_param0 []io.Writer) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
