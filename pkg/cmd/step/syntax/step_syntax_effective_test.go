						...
						Pipeline: sht.ParsedPipeline(
							sht.PipelineOptions(
								sht.PipelineContainerOptions(
									...
									tb.EnvVar("GOOGLE_APPLICATION_CREDENTIALS", "/builder/home/kaniko-secret.json"),
							...
							sht.PipelineStage("from-build-pack",
								...
								sht.StageStep(sht.StepCmd("jx"), sht.StepDir("/workspace/source"),
									sht.StepImage("nodejs"), sht.StepName("build-kaniko-credentials"),
									sht.StepArg("step"), sht.StepArg("credential"),
									sht.StepArg("-s"), sht.StepArg("kaniko-secret"),
									sht.StepArg("-k"), sht.StepArg("kaniko-secret"),
									sht.StepArg("-f"), sht.StepArg("/builder/home/kaniko-secret.json")),
					...
					PullRequest: &jenkinsfile.PipelineLifecycles{
						Pipeline: sht.ParsedPipeline(
							...
							sht.PipelineStage("from-build-pack",
								...
								sht.StageStep(sht.StepCmd("jx"), sht.StepDir("/workspace/source"),
									sht.StepImage("maven"), sht.StepName("build-kaniko-credentials"),
									sht.StepArg("step"), sht.StepArg("credential"),
									sht.StepArg("-s"), sht.StepArg("kaniko-secret"),
									sht.StepArg("-k"), sht.StepArg("kaniko-secret"),
									sht.StepArg("-f"), sht.StepArg("/builder/home/kaniko-secret.json")),
