						...
						Pipeline: sht.ParsedPipeline(
							...
							sht.PipelineStage("from-build-pack",
								...
								sht.StageStep(sht.StepCmd("/kaniko/executor"), sht.StepDir("/workspace/source"),
									...
									sht.StepArg("--destination=$DOCKER_REGISTRY/$DOCKER_REGISTRY_ORG/$APP_NAME:${inputs.params.version}"),
									sht.StepArg("--cache-repo=$DOCKER_REGISTRY//cache")),
								sht.StageStep(sht.StepCmd("jx step post build --image $DOCKER_REGISTRY/$DOCKER_REGISTRY_ORG/$APP_NAME:$PREVIEW_VERSION"),
						...
						Pipeline: sht.ParsedPipeline(
							...
							sht.PipelineStage("from-build-pack",
								...
								sht.StageStep(sht.StepCmd("/kaniko/executor"), sht.StepDir("/workspace/source"),
									...
									sht.StepArg("--destination=$DOCKER_REGISTRY/$DOCKER_REGISTRY_ORG/$APP_NAME:${inputs.params.version}"),
									sht.StepArg("--cache-repo=$DOCKER_REGISTRY//cache")),
								sht.StageStep(sht.StepCmd("jx step post build --image $DOCKER_REGISTRY/$DOCKER_REGISTRY_ORG/$APP_NAME:${VERSION}"),
