...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BranchBuild) DeepCopyInto(out *BranchBuild) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BranchBuild.
func (in *BranchBuild) DeepCopy() *BranchBuild {
	if in == nil {
		return nil
	}
	out := new(BranchBuild)
