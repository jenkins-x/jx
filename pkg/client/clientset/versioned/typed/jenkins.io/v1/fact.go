...
func (c *facts) Get(name string, options meta_v1.GetOptions) (result *v1.Fact, err error) {
	result = &v1.Fact{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("facts").
...
func (c *facts) List(opts meta_v1.ListOptions) (result *v1.FactList, err error) {
	result = &v1.FactList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("facts").
...
func (c *facts) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("facts").
...
func (c *facts) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *facts) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("facts").
