...
func (c *FakeEnvironmentRoleBindings) Get(name string, options v1.GetOptions) (result *jenkins_io_v1.EnvironmentRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(environmentrolebindingsResource, c.ns, name), &jenkins_io_v1.EnvironmentRoleBinding{})

	if obj == nil {
		return nil, err
	}
	return obj.(*jenkins_io_v1.EnvironmentRoleBinding), err
}
...
func (c *FakeEnvironmentRoleBindings) List(opts v1.ListOptions) (result *jenkins_io_v1.EnvironmentRoleBindingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(environmentrolebindingsResource, environmentrolebindingsKind, c.ns, opts), &jenkins_io_v1.EnvironmentRoleBindingList{})
	...
	list := &jenkins_io_v1.EnvironmentRoleBindingList{ListMeta: obj.(*jenkins_io_v1.EnvironmentRoleBindingList).ListMeta}
	for _, item := range obj.(*jenkins_io_v1.EnvironmentRoleBindingList).Items {
...
func (c *FakeEnvironmentRoleBindings) Create(environmentRoleBinding *jenkins_io_v1.EnvironmentRoleBinding) (result *jenkins_io_v1.EnvironmentRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(environmentrolebindingsResource, c.ns, environmentRoleBinding), &jenkins_io_v1.EnvironmentRoleBinding{})
...
func (c *FakeEnvironmentRoleBindings) Update(environmentRoleBinding *jenkins_io_v1.EnvironmentRoleBinding) (result *jenkins_io_v1.EnvironmentRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(environmentrolebindingsResource, c.ns, environmentRoleBinding), &jenkins_io_v1.EnvironmentRoleBinding{})
...
func (c *FakeEnvironmentRoleBindings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(environmentrolebindingsResource, c.ns, name), &jenkins_io_v1.EnvironmentRoleBinding{})
...
func (c *FakeEnvironmentRoleBindings) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &jenkins_io_v1.EnvironmentRoleBindingList{})
	return err
}
...
func (c *FakeEnvironmentRoleBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *jenkins_io_v1.EnvironmentRoleBinding, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(environmentrolebindingsResource, c.ns, name, data, subresources...), &jenkins_io_v1.EnvironmentRoleBinding{})
