...
func (c *FakeFacts) Get(name string, options v1.GetOptions) (result *jenkins_io_v1.Fact, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(factsResource, c.ns, name), &jenkins_io_v1.Fact{})

	if obj == nil {
		return nil, err
	}
	return obj.(*jenkins_io_v1.Fact), err
}
...
func (c *FakeFacts) List(opts v1.ListOptions) (result *jenkins_io_v1.FactList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(factsResource, factsKind, c.ns, opts), &jenkins_io_v1.FactList{})
	...
	list := &jenkins_io_v1.FactList{ListMeta: obj.(*jenkins_io_v1.FactList).ListMeta}
	for _, item := range obj.(*jenkins_io_v1.FactList).Items {
...
func (c *FakeFacts) Create(fact *jenkins_io_v1.Fact) (result *jenkins_io_v1.Fact, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(factsResource, c.ns, fact), &jenkins_io_v1.Fact{})
...
func (c *FakeFacts) Update(fact *jenkins_io_v1.Fact) (result *jenkins_io_v1.Fact, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(factsResource, c.ns, fact), &jenkins_io_v1.Fact{})
...
func (c *FakeFacts) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(factsResource, c.ns, name), &jenkins_io_v1.Fact{})
...
func (c *FakeFacts) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &jenkins_io_v1.FactList{})
	return err
}
...
func (c *FakeFacts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *jenkins_io_v1.Fact, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(factsResource, c.ns, name, data, subresources...), &jenkins_io_v1.Fact{})
