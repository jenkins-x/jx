...
func (c *FakeSourceRepositoryGroups) Get(name string, options v1.GetOptions) (result *jenkins_io_v1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(sourcerepositorygroupsResource, c.ns, name), &jenkins_io_v1.SourceRepositoryGroup{})

	if obj == nil {
		return nil, err
	}
	return obj.(*jenkins_io_v1.SourceRepositoryGroup), err
}
...
func (c *FakeSourceRepositoryGroups) List(opts v1.ListOptions) (result *jenkins_io_v1.SourceRepositoryGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(sourcerepositorygroupsResource, sourcerepositorygroupsKind, c.ns, opts), &jenkins_io_v1.SourceRepositoryGroupList{})
	...
	list := &jenkins_io_v1.SourceRepositoryGroupList{ListMeta: obj.(*jenkins_io_v1.SourceRepositoryGroupList).ListMeta}
	for _, item := range obj.(*jenkins_io_v1.SourceRepositoryGroupList).Items {
...
func (c *FakeSourceRepositoryGroups) Create(sourceRepositoryGroup *jenkins_io_v1.SourceRepositoryGroup) (result *jenkins_io_v1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(sourcerepositorygroupsResource, c.ns, sourceRepositoryGroup), &jenkins_io_v1.SourceRepositoryGroup{})
...
func (c *FakeSourceRepositoryGroups) Update(sourceRepositoryGroup *jenkins_io_v1.SourceRepositoryGroup) (result *jenkins_io_v1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(sourcerepositorygroupsResource, c.ns, sourceRepositoryGroup), &jenkins_io_v1.SourceRepositoryGroup{})
...
func (c *FakeSourceRepositoryGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(sourcerepositorygroupsResource, c.ns, name), &jenkins_io_v1.SourceRepositoryGroup{})
...
func (c *FakeSourceRepositoryGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &jenkins_io_v1.SourceRepositoryGroupList{})
	return err
}
...
func (c *FakeSourceRepositoryGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *jenkins_io_v1.SourceRepositoryGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(sourcerepositorygroupsResource, c.ns, name, data, subresources...), &jenkins_io_v1.SourceRepositoryGroup{})
