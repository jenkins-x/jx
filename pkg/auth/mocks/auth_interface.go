...
func (c *MockConfigSaver_SaveConfig_OngoingVerification) GetCapturedArguments() *auth.Config {
	_param0 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1]
}

func (c *MockConfigSaver_SaveConfig_OngoingVerification) GetAllCapturedArguments() (_param0 []*auth.Config) {
