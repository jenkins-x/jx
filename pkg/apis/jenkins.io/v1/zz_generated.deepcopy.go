...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplictionSpec) DeepCopyInto(out *ApplictionSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplictionSpec.
func (in *ApplictionSpec) DeepCopy() *ApplictionSpec {
	if in == nil {
		return nil
	}
	out := new(ApplictionSpec)
	in.DeepCopyInto(out)
	return out
}
