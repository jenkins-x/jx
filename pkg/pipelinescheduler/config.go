...
type Scheduler struct {
	...
	Triggers        *ReplaceableSliceOfTriggers        `json:"triggers,omitempty"`
...
// ReplaceableSliceOfTriggers is a slice of triggers that can optionally completely replace a slice of triggers
// defined in any parent scheduler
