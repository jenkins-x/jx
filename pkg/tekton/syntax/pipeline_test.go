		...
		},
		{
			...
			tasks: []*tektonv1alpha1.Task{
				...
				tb.Task("somepipeline-another-stage-1", "jx", TaskStageLabel("Another stage"), tb.TaskSpec(
					tb.TaskInputs(
						tb.InputsResource("workspace", tektonv1alpha1.PipelineResourceTypeGit)),
					tb.TaskOutputs(tb.OutputsResource("workspace", tektonv1alpha1.PipelineResourceTypeGit)), tb.Step("step2", "some-image", tb.Command("/bin/sh", "-c"), tb.Args("echo again"), workingDir("/workspace/source")),
				)),
			},
			structure: PipelineStructure("somepipeline-1",
				StructureStage("A Working Stage", StructureStageTaskRef("somepipeline-a-working-stage-1")),
		...
		},
		{
			...
			tasks: []*tektonv1alpha1.Task{
				...
				tb.Task("somepipeline-last-stage-1", "jx", TaskStageLabel("Last Stage"), tb.TaskSpec(
					tb.TaskInputs(
						tb.InputsResource("workspace", tektonv1alpha1.PipelineResourceTypeGit)),
					tb.TaskOutputs(tb.OutputsResource("workspace", tektonv1alpha1.PipelineResourceTypeGit)), tb.Step("step2", "some-image", tb.Command("/bin/sh", "-c"), tb.Args("echo last"), workingDir("/workspace/source")),
				)),
			},
			structure: PipelineStructure("somepipeline-1",
