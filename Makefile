...
preview: linux
	docker build --no-cache -t docker.io/builder-maven:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER -f Dockerfile.maven .
	docker push docker.io/builder-maven:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER
	docker build --no-cache -t docker.io/builder-go:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER -f Dockerfile.buildgo .
	docker push docker.io/builder-go:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER
	docker build --no-cache -t docker.io/builder-nodejs:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER -f Dockerfile.nodejs .
	docker push docker.io/builder-nodejs:SNAPSHOT-$BRANCH_NAME-$BUILD_NUMBER
