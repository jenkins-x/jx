...
---------- | ------- | ------- | -------------------
[jenkins-x/jx-admin](https://github.com/jenkins-x/jx-admin) |  | [0.0.63](https://github.com/jenkins-x/jx-admin/releases/tag/v0.0.63) | 
[jenkins-x/jx-secret](https://github.com/jenkins-x/jx-secret) |  | [0.0.72](https://github.com/jenkins-x/jx-secret/releases/tag/v0.0.72) | 
...
[jenkins-x/jx-gitops](https://github.com/jenkins-x/jx-gitops) |  | [0.0.176](https://github.com/jenkins-x/jx-gitops/releases/tag/v0.0.176) | 
