...
---------- | ------- | ------- | -------------------
[jenkins-x/jx-admin](https://github.com/jenkins-x/jx-admin) |  | [0.0.61](https://github.com/jenkins-x/jx-admin/releases/tag/v0.0.61) | 
[jenkins-x/jx-secret](https://github.com/jenkins-x/jx-secret) |  | [0.0.54](https://github.com/jenkins-x/jx-secret/releases/tag/v0.0.54) | 
...
[jenkins-x/jx-gitops](https://github.com/jenkins-x/jx-gitops) |  | [0.0.168](https://github.com/jenkins-x/jx-gitops/releases/tag/v0.0.168) | 
