        ...
        stage('CI Build and Test') {
            ...
            steps {
                dir ('/home/jenkins/go/src/github.com/jenkins-x/jx') {
                    ...
                    sh "./build/linux/jx step bdd -b  --provider=gke --git-provider=ghe --git-provider-url=https://github.beescloud.com --git-username dev1 --git-api-token $GHE_CREDS_PSW --default-admin-password $JENKINS_CREDS_PSW --no-delete-app --no-delete-repo --tests install --tests test-quickstart-node-http"
